...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', type=str, default="VAE-2000",
                        help='choose a model')

    parser.add_argument('--x_latent_size', type=int, default=10,
    ...
    parser.add_argument('--model_id', type=str, default="13",
                        help='model id')
